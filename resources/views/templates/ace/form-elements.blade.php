...
@section('styles')
    ...
    {{ Html::style('/templates/ace/assets/css/chosen.min.css') }}
    {{ Html::style('/templates/ace/assets/css/bootstrap-datepicker3.min.css') }}
    {{ Html::style('/templates/ace/assets/css/bootstrap-timepicker.min.css') }}
    {{ Html::style('/templates/ace/assets/css/daterangepicker.min.css') }}
    {{ Html::style('/templates/ace/assets/css/bootstrap-datetimepicker.min.css') }}
    {{ Html::style('/templates/ace/assets/css/bootstrap-colorpicker.min.css') }}
@endsection
...
@section('pre-scripts')
    ...
    {{ Html::script('/templates/ace/assets/js/chosen.jquery.min.js') }}
    {{ Html::script('/templates/ace/assets/js/spinbox.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-datepicker.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-timepicker.min.js') }}
    {{ Html::script('/templates/ace/assets/js/moment.min.js') }}
    {{ Html::script('/templates/ace/assets/js/daterangepicker.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-datetimepicker.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-colorpicker.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery.knob.min.js') }}
    {{ Html::script('/templates/ace/assets/js/autosize.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery.inputlimiter.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery.maskedinput.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-tag.min.js') }}
@endsection
