...
@section('pre-scripts')
    {{ Html::script('/templates/ace/assets/js/wizard.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery.validate.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery-additional-methods.min.js') }}
