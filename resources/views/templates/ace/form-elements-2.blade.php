...
@section('styles')
{{ Html::style('/templates/ace/assets/css/bootstrap-duallistbox.min.css') }}
{{ Html::style('/templates/ace/assets/css/bootstrap-multiselect.min.css') }}
...
@section('pre-scripts')
    {{ Html::script('/templates/ace/assets/js/jquery.bootstrap-duallistbox.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery.raty.min.js') }}
    {{ Html::script('/templates/ace/assets/js/bootstrap-multiselect.min.js') }}
    {{ Html::script('/templates/ace/assets/js/select2.min.js') }}
    {{ Html::script('/templates/ace/assets/js/jquery-typeahead.js') }}
@endsection
