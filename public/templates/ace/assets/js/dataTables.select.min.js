...
(function (a, b, c, d) {
	...
	function e(a, b, c) {
		...
		a.cells({
			selected: !0
		}).any() || c ? (e = g(c.column, b.column), f = h(c.row, b.row)) : (e = g(0, b.column), f = h(0, b.row)),
	...
	function f(b) {
		...
		a(b.table().body()).off("mousedown.dtSelect", d).off("mouseup.dtSelect", d).off("click.dtSelect", d),
	...
	function g(c) {
		...
		a("body").on("click.dtSelect", function (b) {
			if (e._select.blurable) {
				if (a(b.target).parents().filter(c.table().container()).length)
					return;
				if (a(b.target).parents("div.DTE").length)
					return;
				l(e, !0)
			}
		})
	...
	function k(b, c, d, e) {
		...
		if (b[c + "s"]({
			...
			f.splice(h + 1, f.length),
			f.splice(0, g)
		} else
			f.splice(a.inArray(d, f) + 1, f.length);
		b[c](d, {
			selected: !0
	...
	function m(a, b, c, d, f) {
		...
		if ("os" === g)
			if (a.ctrlKey || a.metaKey)
				...
				"cell" === d ? e(b, f, c._select_lastCell || null) : k(b, d, f, c._select_lastCell ? c._select_lastCell[d] : null);
			else {
				var i = b[d + "s"]({
						selected: !0
					});
	...
	o.select.init = function (b) {
		...
		m = "selected";
		c._select = {},
		g === !0 ? i = "os" : "string" == typeof g ? i = g : a.isPlainObject(g) && (g.blurable !== d && (j = g.blurable), g.info !== d && (k = g.info), g.items !== d && (h = g.items), g.style !== d && (i = g.style), g.selector !== d && (l = g.selector), g.className !== d && (m = g.className)),
		b.select.selector(l),
		b.select.items(h),
		b.select.style(i),
		b.select.blurable(j),
	...
	a.each([{
		...
		o.ext.selector[b.type].push(function (a, c, e) {
			...
			for (var i = 0, j = e.length; j > i; i++)
				f = a[b.prop][e[i]], (g === !0 && f._select_selected === !0 || g === !1 && !f._select_selected) && h.push(e[i]);
			return h
		})
	}),
	...
	q("columns().deselect()", "column().deselect()", function () {
		...
		return this.iterator("column", function (b, c) {
			...
			d.cells(null, c).indexes().each(function (c) {
	...
	q("cells().deselect()", "cell().deselect()", function () {
		...
		return this.iterator("cell", function (b, c, d) {
			...
			e.anCells && !b.aoColumns[d]._select_selected && a(e.anCells[d]).removeClass(b._select.className)
		}),
		this.iterator("table", function (a, c) {
